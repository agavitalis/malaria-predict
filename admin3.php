	...
	<div class="center-container">
		<div class="banner wthree">
			<div class="container">
                ...
                <div class="col-md-6 callbacks_container form-w3l-agil3">
					<div class="book-form">
					<p>TEMPERATURE</p>
					   <form action="#" method="post">
							
							<div class="form-date-w3-agileits">
									<label><i class="fa fa-question" aria-hidden="true"></i>High :</label>
									<input  type="number" name="high" value="" required="">
							</div>
							
							<div class="form-date-w3-agileits">
									<label><i class="fa fa-question" aria-hidden="true"></i>Normal :</label>
									<input  type="number"  name="normal" value="" required="">
							</div>
                            
                            <div class="form-date-w3-agileits">
									<label><i class="fa fa-question" aria-hidden="true"></i>Low :</label>
									<input  type="number"  name="low" value="" required="">
							</div>
							<div class="form-date-w3-agileits temperature_message alert hidden">
                                <i class="" id="temperature_text"></i>
                            </div>
							<div class="form-left-agileits-submit">
								
								<input id="temperature_variable" type="button" value="ADD">
                 ...
                 <div class="col-md-6 callbacks_container form-w3l-agil3">
					...
					<p>HUMIDITY</p>
					   <form action="#" method="post">
							...
							<div class="form-date-w3-agileits">
									<label><i class="fa fa-question" aria-hidden="true"></i>High Humidity :</label>
									<input  type="number" name="high_h" value="" required="">
							</div>
							
							<div class="form-date-w3-agileits">
									<label><i class="fa fa-question" aria-hidden="true"></i>Normal Humidity:</label>
									<input  type="number" name="normal_h" value="" required="">
							</div>
                            
                            <div class="form-date-w3-agileits">
									<label><i class="fa fa-question" aria-hidden="true"></i>Low Humidity:</label>
									<input  type="number" name="low_h" value="" required="">
							</div>
							<div class="form-date-w3-agileits humidity_message alert hidden">
                                <i class="" id="humidity_text"></i>
                            </div>	 
							<div class="form-left-agileits-submit">
								
								<input id="humidity_variable" type="button" value="ADD">
